...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-23.5 left-6 z-30 grid h-14 w-14 place-items-center rounded-full bg-[#25D366] shadow-xl ring-2 ring-white hover:scale-105 transition"
    >
