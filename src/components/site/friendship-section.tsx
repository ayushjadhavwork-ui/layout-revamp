          ...
          {designs.map((item, idx) => {
            ...
            return (
              <div
                ...
                className={`relative rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 flex flex-col items-center text-center transition bg-black/15 cursor-pointer select-none ${
                  active ? "ring-2 ring-off-white" : "ring-1 ring-pink-mist/30"
              ...
              >
                ...
                <div
                  ...
                  className="relative w-full aspect-[1082/708] overflow-hidden rounded-lg sm:rounded-xl bg-white cursor-zoom-in"
                >
